...
class SportsDbService:
  def __init__(self, db_session: AsyncSession):
    ...
    self.countries_cases={"spain":{"id":"4335","name":"Spanish La Liga","strMap":"40°00′00″N 4°00′00″W"},"brasil":{"id":"4351","name":"Brazilian Serie A","strMap":"15°47′38″S 47°52′58″W"}}

  async def get_league_matches(self, country:str="") -> dict:
    # Verificar si el usuario ya existe
    date = datetime.datetime.now()
    lower_country = country.lower()
    yearly_seasons_leagues=["brasil"] # Leagues that have a yearly season and not a bi-yearly season
